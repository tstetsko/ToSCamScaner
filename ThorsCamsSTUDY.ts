...
# Get the close of two days ago --- I added this (Leslie)
...
# Range Day Type
AddLabel(yes, if closePrevDay > closeTwoDaysAgo then "Cams: Higher Range"
         else if closePrevDay < closeTwoDaysAgo then "Cams: Lower Range"
         else "Cams: Neutral Range",
         if closePrevDay > closeTwoDaysAgo then GlobalColor("Cams Higher Range Label Color")
         else if closePrevDay < closeTwoDaysAgo then GlobalColor("Cams Lower Range Label Color")
